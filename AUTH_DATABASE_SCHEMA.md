...
```bash
"C:\Program Files\PostgreSQL\18\bin\psql.exe" "postgresql://wihngo@dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com:5432/wihngo_kzno?sslmode=require" -f Database\queries\quick_auth_view.sql
```

### Full Report (All Details)
```bash
"C:\Program Files\PostgreSQL\18\bin\psql.exe" "postgresql://wihngo@dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com:5432/wihngo_kzno?sslmode=require" -f Database\queries\view_auth_database.sql
```
