...
```
Host=dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com;Port=5432;Database=wihngo_kzno;Username=wihngo;Password=adMdetBUaXezA4UQoOfq0Dd6NjCb7XUx;SSL Mode=Require;Trust Server Certificate=True
```
...
```powershell
[System.Environment]::SetEnvironmentVariable('DEFAULT_CONNECTION', 'Host=dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com;Port=5432;Database=wihngo_kzno;Username=wihngo;Password=adMdetBUaXezA4UQoOfq0Dd6NjCb7XUx;SSL Mode=Require;Trust Server Certificate=True', 'User')
```

**Or User Secrets (Easier):**
```bash
cd C:\.net\Wihngo
dotnet user-secrets set "DEFAULT_CONNECTION" "Host=dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com;Port=5432;Database=wihngo_kzno;Username=wihngo;Password=adMdetBUaXezA4UQoOfq0Dd6NjCb7XUx;SSL Mode=Require;Trust Server Certificate=True"
```
...
```
DEFAULT_CONNECTION = Host=dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com;Port=5432;Database=wihngo_kzno;Username=wihngo;Password=adMdetBUaXezA4UQoOfq0Dd6NjCb7XUx;SSL Mode=Require;Trust Server Certificate=True;Pooling=true
```
