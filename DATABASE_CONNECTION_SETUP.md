...
```
DEFAULT_CONNECTION = Host=dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com;Port=5432;Database=wihngo_kzno;Username=wihngo;Password=adMdetBUaXezA4UQoOfq0Dd6NjCb7XUx;Pooling=true;SSL Mode=Require;Trust Server Certificate=True
```
