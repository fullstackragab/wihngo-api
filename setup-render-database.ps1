...
Write-Host "   Host: dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com" -ForegroundColor Cyan
Write-Host "   Database: wihngo_kzno" -ForegroundColor Cyan
Write-Host ""

# Run the setup script
psql -h dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com `
     -U wihngo `
     -d wihngo_kzno `
