...
"C:\Program Files\PostgreSQL\18\bin\psql.exe" "postgresql://wihngo@dpg-d4u4tb7gi27c73e5nui0-a.oregon-postgres.render.com:5432/wihngo_kzno?sslmode=require" -f Database\migrations\simple_fix.sql
```
