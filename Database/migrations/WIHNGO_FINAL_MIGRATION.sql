-- =====================================================
-- WIHNGO CRYPTO WALLET CONFIGURATION - FINAL VERSION
-- =====================================================
-- This script configures your Wihngo crypto payment system
-- Currencies: USDC, EURC
-- Networks: Solana, Ethereum, Polygon, Base, Stellar
-- Total: 10 wallet entries
-- =====================================================

BEGIN;

-- Step 1: Deactivate old wallets (if they exist)
...
-- Step 2: Insert USDC wallets (5 networks)
...
-- Step 3: Insert EURC wallets (5 networks)
INSERT INTO platform_wallets (id, currency, network, address, is_active, created_at, updated_at)
VALUES 
