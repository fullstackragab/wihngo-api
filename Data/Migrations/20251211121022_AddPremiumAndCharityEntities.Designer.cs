...
namespace Wihngo.Data.Migrations
{
    ...
    [Migration("20251211121022_AddPremiumAndCharityEntities")]
    partial class AddPremiumAndCharityEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wihngo.Models.Entities.CryptoExchangeRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e91cde8e-e389-401c-89a6-43bc056beebf"),
                            Currency = "BTC",
                            LastUpdated = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(452),
                            Source = "coingecko",
                            UsdRate = 50000m
                        },
                        new
                        {
                            Id = new Guid("fadaeb59-097b-484f-9b48-f4eee141fa83"),
                            Currency = "ETH",
                            LastUpdated = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(467),
                            Source = "coingecko",
                            UsdRate = 3000m
                        },
                        new
                        {
                            Id = new Guid("29768fb7-037b-4da0-99e4-ff1ddb1e753c"),
                            Currency = "USDT",
                            LastUpdated = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(469),
                            Source = "coingecko",
                            UsdRate = 1m
                        },
                        new
                        {
                            Id = new Guid("a3207aab-5001-4273-ab94-ff67504b7386"),
                            Currency = "USDC",
                            LastUpdated = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(472),
                            Source = "coingecko",
                            UsdRate = 1m
                        },
                        new
                        {
                            Id = new Guid("b47fb181-e5ef-44aa-9edc-20b55f58205c"),
                            Currency = "BNB",
                            LastUpdated = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(474),
                            Source = "coingecko",
                            UsdRate = 500m
                        },
                        new
                        {
                            Id = new Guid("042d4663-44ac-40c6-82fc-329b6cba29e0"),
                            Currency = "SOL",
                            LastUpdated = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(478),
                            Source = "coingecko",
                            UsdRate = 100m
                        },
                        new
                        {
                            Id = new Guid("b3be5e20-77eb-4140-a744-0a515f3a2113"),
                            Currency = "DOGE",
                            LastUpdated = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(480),
                            Source = "coingecko",
                            UsdRate = 0.1m
                        });
                });
            ...
            modelBuilder.Entity("Wihngo.Models.Entities.PlatformWallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a989ec71-d964-4e85-a757-a20d607d4917"),
                            Address = "TGRzhw2kwBW5PzncWfKCnqsvkrBezfsgiA",
                            CreatedAt = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(311),
                            Currency = "USDT",
                            IsActive = true,
                            Network = "tron",
                            UpdatedAt = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(312)
                        },
                        new
                        {
                            Id = new Guid("1ae09ada-105b-4d2b-a255-768374709e85"),
                            Address = "0x4cc28f4cea7b440858b903b5c46685cb1478cdc4",
                            CreatedAt = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(316),
                            Currency = "USDT",
                            IsActive = true,
                            Network = "ethereum",
                            UpdatedAt = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(316)
                        },
                        new
                        {
                            Id = new Guid("35d4c7d4-ee68-47c1-9ff1-a449fa7da91d"),
                            Address = "0x83675000ac9915614afff618906421a2baea0020",
                            CreatedAt = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(320),
                            Currency = "USDT",
                            IsActive = true,
                            Network = "binance-smart-chain",
                            UpdatedAt = new DateTime(2025, 12, 11, 12, 10, 21, 606, DateTimeKind.Utc).AddTicks(320)
                        });
                });
