...
namespace Wihngo.Data.Migrations
{
    ...
    [Migration("20251210001226_AddDonationCentsToBirds")]
    partial class AddDonationCentsToBirds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wihngo.Models.Entities.CryptoExchangeRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("59b7b668-b1ba-40b5-be17-4bbb6d69cd72"),
                            Currency = "BTC",
                            LastUpdated = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(572),
                            Source = "coingecko",
                            UsdRate = 50000m
                        },
                        new
                        {
                            Id = new Guid("bfb4bc3e-b936-41c8-a7d8-120944b066c9"),
                            Currency = "ETH",
                            LastUpdated = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(577),
                            Source = "coingecko",
                            UsdRate = 3000m
                        },
                        new
                        {
                            Id = new Guid("b70e13d4-4c36-4848-82b7-250952e56422"),
                            Currency = "USDT",
                            LastUpdated = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(580),
                            Source = "coingecko",
                            UsdRate = 1m
                        },
                        new
                        {
                            Id = new Guid("dd0ee405-6005-4a5c-ad8b-e243c375be00"),
                            Currency = "USDC",
                            LastUpdated = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(585),
                            Source = "coingecko",
                            UsdRate = 1m
                        },
                        new
                        {
                            Id = new Guid("78211331-477d-4399-9bb2-e63c2e939852"),
                            Currency = "BNB",
                            LastUpdated = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(587),
                            Source = "coingecko",
                            UsdRate = 500m
                        },
                        new
                        {
                            Id = new Guid("5a2cca79-293b-4863-a1e3-e8f3be525bfe"),
                            Currency = "SOL",
                            LastUpdated = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(589),
                            Source = "coingecko",
                            UsdRate = 100m
                        },
                        new
                        {
                            Id = new Guid("7bac845b-a02a-4d7d-83ea-0727898e73d4"),
                            Currency = "DOGE",
                            LastUpdated = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(591),
                            Source = "coingecko",
                            UsdRate = 0.1m
                        });
                });
            ...
            modelBuilder.Entity("Wihngo.Models.Entities.PlatformWallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1a0b9e7d-73b7-436d-8b46-780a3b5b35f8"),
                            Address = "TGRzhw2kwBW5PzncWfKCnqsvkrBezfsgiA",
                            CreatedAt = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(434),
                            Currency = "USDT",
                            IsActive = true,
                            Network = "tron",
                            UpdatedAt = new DateTime(2025, 12, 10, 0, 12, 25, 874, DateTimeKind.Utc).AddTicks(435)
                        });
                });
