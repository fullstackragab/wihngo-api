...
namespace Wihngo.Data
{
    ...
    public class AppDbContext : IDisposable
    {
        ...
        public StubDbSet<PlatformWallet> PlatformWallets => new StubDbSet<PlatformWallet>(_dbFactory, "platform_wallets", "id", _logger);
        public StubDbSet<CryptoPaymentRequest> CryptoPaymentRequests => new StubDbSet<CryptoPaymentRequest>(_dbFactory, "crypto_payment_requests", "request_id", _logger);
        ...
        public StubDbSet<Invoice> Invoices => new StubDbSet<Invoice>(_dbFactory, "invoices", "id", _logger);
        public StubDbSet<Payment> Payments => new StubDbSet<Payment>(_dbFactory, "payments", "id", _logger);
        ...
        public StubDbSet<PaymentEvent> PaymentEvents => new StubDbSet<PaymentEvent>(_dbFactory, "payment_events", "id", _logger);
